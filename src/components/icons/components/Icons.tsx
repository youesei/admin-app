...
import type { CaretIconTypes } from "../types/types";
...
export function LogoutIcon(props: SVGProps<SVGSVGElement>) {
	const defaultStroke = props.stroke ? props.stroke : "#dc2626";
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
...
export function DeliveryIcon(props: SVGProps<SVGSVGElement>) {
	return (
		...
		>
			<path
				d="M125.3 289.3c17.3 0 33.7 6.8 46.1 19.2 12.4 12.4 19.2 28.8 19.2 46.1s-6.8 33.7-19.2 46.1c-12.4 12.4-28.8 19.2-46.1 19.2s-33.7-6.8-46.1-19.2C66.8 388.4 60 372 60 354.7s6.8-33.7 19.2-46.1c12.4-12.4 28.8-19.3 46.1-19.3m0-28c-51.3 0-93.3 42-93.3 93.3C32 406 74 448 125.3 448s93.3-42 93.3-93.3c.1-51.4-41.9-93.4-93.3-93.4z"
				fill="currentColor"
			/>
			<path
				d="M319.8 127.8c17.8 0 32-14.2 32-32S337.8 64 320 64s-32.2 14-32.2 31.8c0 17.7 14.3 32 32 32z"
				fill="currentColor"
			/>
			<path
				d="M386.7 289.3c17.3 0 33.7 6.8 46.1 19.2 12.4 12.4 19.2 28.8 19.2 46.1s-6.8 33.7-19.2 46.1C420.4 413.2 404 420 386.7 420s-33.7-6.8-46.1-19.2c-12.4-12.4-19.2-28.8-19.2-46.1s6.8-33.7 19.2-46.1c12.3-12.4 28.7-19.3 46.1-19.3m0-28c-51.3 0-93.3 42-93.3 93.3s42 93.3 93.3 93.3 93.3-42 93.3-93.3-42-93.3-93.3-93.3z"
				fill="currentColor"
			/>
			<path
...
export function HamburguerMenu(props: SVGProps<SVGSVGElement>) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
...
export function ReportsIcon(props: SVGProps<SVGSVGElement>) {
	return (
		...
		>
			<path
				fill="currentColor"
				d="M5.116 20q-.691 0-1.153-.462T3.5 18.384V3.5q0-.213.144-.356T4.001 3t.356.144t.143.356v14.885q0 .23.192.423t.423.192H20q.213 0 .356.144t.144.357t-.144.356T20 20zm3-3.5q-.311 0-.521-.21t-.21-.52V9.922q0-.31.21-.52t.52-.21h.462q.343 0 .576.233q.232.234.232.58v5.689q0 .346-.233.575q-.232.23-.575.23zm4.5 0q-.311 0-.521-.21t-.21-.52V5q0-.343.232-.575t.575-.233h.462q.31 0 .52.21t.21.521v10.77q0 .343-.231.575q-.233.232-.576.232zm4.5 0q-.311 0-.521-.21t-.21-.52V14q0-.343.232-.575t.575-.233h.462q.31 0 .52.21t.21.521v1.77q0 .343-.231.575t-.576.232z"
			/>
		</svg>
	);
}

export function TurnIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
...
export function CaretIcon({ upColor, downColor, ...props }: CaretIconTypes) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width="1em"
		...
		>
			<path
				fill={upColor}
				fillRule="evenodd"
				d="M12 6.273a.73.73 0 0 0-.18-.479L8.8 2.342A1 1 0 0 0 8.046 2h-.092a1 1 0 0 0-.753.341L4.18 5.794A.727.727 0 0 0 4.727 7h6.546A.727.727 0 0 0 12 6.273"
				clipRule="evenodd"
			/>
			<path
				fill={downColor}
				fillRule="evenodd"
				d="M4 9.727c0 .176.064.346.18.479l3.02 3.453a1 1 0 0 0 .753.341h.092a1 1 0 0 0 .753-.341l3.021-3.453A.727.727 0 0 0 11.273 9H4.727A.727.727 0 0 0 4 9.727"
				clipRule="evenodd"
			/>
		</svg>
	);
